...
### 🏛️ Desarrollador Backend | Municipalidad de Palestina De Los Altos
**Julio 2025 – Diciembre 2025**

Lideré el desarrollo del backend de un sistema de gestión municipal completo:

- 🔧 Desarrollo y mantenimiento de arquitectura backend robusta
- 🌐 Creación de APIs RESTful y lógica de negocio compleja
- 🗄️ Gestión de bases de datos relacionales (MySQL, SQLServer)
- 🗺️ Procesamiento y manejo de datos geoespaciales
- 📝 Implementación de pruebas y documentación técnica exhaustiva
- ⚡ Optimización de rendimiento y escalabilidad del sistema

### 🛒 Sistema de Comercio Electrónico Full Stack
**Julio 2024 – Diciembre 2024**

Desarrollé una aplicación e-commerce completa desde cero con tecnologías modernas:

**Frontend:**
- ⚛️ ReactJS, TypeScript y Next.js para interfaces dinámicas
- 📱 Diseño responsivo y optimizado para UX/UI
- 🎨 Implementación de componentes reutilizables y escalables

**Backend & Integraciones:**
- 🔌 Strapi CMS para gestión de contenido y productos
- 💳 Integración de Stripe para pagos seguros en tiempo real
- 🛍️ Desarrollo de catálogo, carrito de compras y checkout
...
🎓 Ingeniería en Sistemas, Informática y Ciencias de la Computación
   Universidad Mesoamericana | 2021 - 2026 (Pensum cerrado)

📚 Clases de Inglés - Nivel Intermedio
   Academia Europea | Enero 2025 - Diciembre 2025

🎯 Bachiller en Ciencias y Letras con Orientación en Ciencias de la Computación
...
|-------------|---------------|----------------|
| **Sistema Municipal** | FastAPI, MySQL, PostgreSQL | Backend completo para gestión municipal con datos geoespaciales |
| **E-commerce Full Stack** | React, Next.js, Strapi, Stripe | Tienda online con pagos integrados y CMS |
| **Portfolio Personal** | React, TypeScript | [portafoliowxi.netlify.app](https://portafoliowxi.netlify.app/) |
...
> 
> 🛠️ Construyo soluciones con **pasión** y **propósito**  
> 🌱 Aprendo **constantemente** nuevas tecnologías  
> 🤝 Colaboro con **excelencia** y **compromiso**  
> ✝️ Mis principios cristianos guían mi **ética de trabajo**
...
[![WhatsApp](https://img.shields.io/badge/📱_WhatsApp-+502_5982_6624-25D366?style=for-the-badge&logo=whatsapp&logoColor=white)](https://wa.me/50259826624)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Wilver_Xiá-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/tu-usuario)
...
### 🎯 Actualmente buscando oportunidades para:

`Desarrollo Full Stack` • `Proyectos Backend` • `APIs Escalables` • `Innovación Tecnológica`
